...
//		BufferedWriter bw = new BufferedWriter(osw);
		...
		fw.write("Do mesmo modo, o novo modelo estrutural aqui preconizado maximiza as possibilidades por conta do fluxo de informações. É importante questionar o quanto o julgamento imparcial das eventualidades cumpre um papel essencial na formulação das direções preferenciais no sentido do progresso. As experiências acumuladas demonstram que o acompanhamento das preferências de consumo é uma das consequências das condições financeiras e administrativas exigidas.");
		fw.close();
	}
